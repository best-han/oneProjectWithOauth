...
import com.windaka.suizhi.zjj.oauth.RandomAuthenticationKeyGenerator;
import com.windaka.suizhi.zjj.oauth.RedisAuthorizationCodeServices;
import com.windaka.suizhi.zjj.oauth.RedisClientDetailsService;
...
//		endpoints.authorizationCodeServices(new JdbcAuthorizationCodeServices(dataSource));
	...
	/*	clients.inMemory().withClient("system").secret(bCryptPasswordEncoder.encode("system"))
				.authorizedGrantTypes("password", "authorization_code", "refresh_token").scopes("oss")
...
//		clients.jdbc(dataSource);
     ...
     */
    @Value("${access_token.jwt-signing-key:QingdaoAisino}")
